  ...
  medievalCastle: {
    ...
    rooms: [
      {
        ...
        description:
          'A grand courtyard with cobblestone paths. The castle entrance looms to the north.',
        graphics: {
      ...
      },
      {
        ...
        name: 'Great Hall',
        description:
          'A magnificent hall with high ceilings and a long dining table.',
        graphics: {
      ...
      },
      {
        ...
        name: 'Castle Tower',
        description:
          'The highest point of the castle with a view of the kingdom.',
        graphics: {
    ...
    objects: [
      ...
      },
      {
        id: 'table',
        name: 'dining table',
        description: 'A long wooden table',
        canTake: false,
        scenery: true,
      },
      {
        id: 'weapon_rack',
        name: 'weapon rack',
        description: 'Holds various weapons',
        canTake: false,
        scenery: true,
      },
      {
      ...
      },
      {
        id: 'telescope',
        name: 'telescope',
        description: 'For viewing distant lands',
        canTake: false,
        canUse: true,
      },
    ],
    ...
    npcs: [
      {
        ...
        dialogue: {
          ...
          topics: {
            quest:
              'I need someone to retrieve the ancient artifact from the tower.',
          },
        },
        relationship: 50,
      },
    ...
    items: [
      {
        id: 'rusty_key',
        name: 'rusty key',
        description: 'Opens the locked door',
        takeable: true,
        usable: true,
      },
      {
      ...
      },
      {
        id: 'magic_amulet',
        name: 'magic amulet',
        description: 'Protects from harm',
        takeable: true,
        usable: true,
      },
    ],
    ...
    rooms: [
      {
        ...
        name: 'Docking Bay',
        description:
          'Your ship is docked here. Stars visible through the bay doors.',
        graphics: {
          backgroundColor: '#000000',
          primitives: [
            // Stars
    ...
    objects: [
      {
        id: 'ship',
        name: 'your ship',
        description: 'Your personal spacecraft',
        canTake: false,
        scenery: true,
      },
      {
      ...
      },
      {
        id: 'light_panel',
        name: 'light panel',
        description: 'Control panel for lights',
        canTake: false,
        canUse: true,
      },
      {
        id: 'main_computer',
        name: 'main computer',
        description: 'Station control system',
        canTake: false,
        canUse: true,
      },
      {
    ...
    items: [
      {
        id: 'access_card',
        name: 'access card',
        description: 'Grants security access',
        takeable: true,
        usable: true,
      },
      {
