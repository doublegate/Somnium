    ...
    objects: [
      {
        ...
        description:
          "Your trusty '47 Packard. She's seen better days, but she's never let you down.",
        state: 'parked',
        canExamine: true,
        canEnter: true,
      },
      ...
      },
      {
        ...
        name: 'wall safe',
        description:
          'A combination safe, now standing open and empty. No signs of forced entry.',
        state: 'open',
        canExamine: true,
        containedItems: [],
      },
      {
        ...
        name: 'blood stain',
        description:
          'A fresh blood stain on the marble. Drag marks lead from here to the study.',
        state: 'fresh',
        canExamine: true,
      },
      {
      ...
      },
      {
        ...
        description:
          'Size 10 mens dress shoes. The mud is still wet. These are recent.',
        state: 'fresh',
        canExamine: true,
      },
    ],
    ...
    items: [
      {
        ...
        name: 'flashlight',
        description:
          'Your police-issue flashlight. Heavy enough to double as a weapon.',
        weight: 1,
        size: 2,
        value: 20,
        takeable: true,
      ...
      },
      {
        ...
        name: 'photograph',
        description:
          'Marcus with a young woman, laughing. Written on the back: "To my love, forever - V."',
        weight: 0.1,
        size: 1,
        value: 150,
        takeable: true,
      ...
      },
      {
        ...
        name: 'love letter',
        description:
          'A passionate letter to Marcus from someone signed only "V". The handwriting is elegant.',
        weight: 0.05,
        size: 1,
        value: 100,
        takeable: true,
      ...
      },
      {
        ...
        name: 'train ticket',
        description:
          'One-way ticket from Chicago, arriving this evening. Passenger name: Victoria Sterling.',
        weight: 0.05,
        size: 1,
        value: 75,
        takeable: true,
      ...
      },
      {
        ...
        name: 'kitchen knife',
        description:
          'An 8-inch chefs knife. The blade has been recently cleaned, but theres blood in the handle grooves.',
        weight: 0.5,
        size: 2,
        value: 50,
        takeable: true,
    ...
    npcs: [
      {
        ...
        dialogue: {
          ...
          topics: {
            ...
            safe: 'Only Mr. Blackwood knew the combination. Well, and possibly Master Victor.',
            embezzling:
      ...
      },
      {
        ...
        name: 'Mrs. Henderson',
        description:
          'A stout woman in her 60s, covered in flour. She seems genuinely distraught.',
        location: 'kitchen',
        mood: 'upset',
        relationship: 20,
        dialogue: {
          greeting:
            'Oh detective, this is just awful! Who would do such a thing?',
          default:
            "I've been preparing dinner all evening. I didn't hear anything unusual.",
          topics: {
            murder:
      ...
      },
      {
        ...
        relationship: -20,
        dialogue: {
          greeting: 'Who are you? Did Eleanor send you? I... I loved Marcus.',
          default: "I don't have to tell you anything. I have rights!",
          topics: {
            murder:
            ...
            safe: 'Marcus said he was keeping money in the safe for our new life together. $50,000.',
            evening:
    ...
    puzzles: [
      {
        ...
        description:
          'Gather evidence and determine who killed Marcus Blackwood.',
        type: 'multi_step',
        steps: [
          {
