...
1. **Prompt Engineering:** The initial and dynamic prompts themselves include instructions to avoid disallowed content. For instance, we add at the end of the prompt: *“Do not include any profanity, slurs, or highly explicit content. Stay in the style of a classic adventure game which is family-friendly.”*
